...
const prompt = ai.definePrompt({
  name: 'applyStyleTransferPrompt',
  input: {schema: ApplyStyleTransferInputSchema},
  output: {schema: ApplyStyleTransferOutputSchema},
  prompt: `Apply the following style to the image:

Style: {{{style}}}
Image: {{media url=photoDataUri}}

Please return the stylized image as a data URI in the styledPhotoDataUri field.`,
});
